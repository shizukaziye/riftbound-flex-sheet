...
- Click any card row for the copy split: how many lists ran it at 3, 2 or 1
  copies or not at all, their share, and the average placing of each group.
  Works in both sideboard views and on the battlefield tables.
